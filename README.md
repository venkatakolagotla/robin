...
Also I have some simple script - `src/dataset/dataset.py`. It can fastly generate train-validation-testing data from provided datasets. It is expected, that you train your simple **robin** on new dataset, then create new dataset with `binarize.py`, correct generated ground-truths and train **robin** again with these new pair of input and ground-truth images.
